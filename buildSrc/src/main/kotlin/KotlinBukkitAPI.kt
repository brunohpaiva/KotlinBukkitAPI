object KotlinBukkitAPI {
    ...
    val plugins = listOf(
        Plugin(
            "Vault",
            setOf("http://nexus.hc.to/content/repositories/pub_releases"),
            setOf("net.milkbowl.vault:VaultAPI:1.6")
        ),
        Plugin(
            "PlaceholderAPI",
            setOf("http://repo.extendedclip.com/content/repositories/placeholderapi/"),
            setOf("me.clip:placeholderapi:2.8.5")
        ),
        Plugin(
            "MVdWPlaceholderAPI",
            setOf("http://repo.mvdw-software.be/content/groups/public/"),
            setOf("be.maximvdw:MVdWPlaceholderAPI:2.5.2-SNAPSHOT")
        ),
        ...
        Plugin(
            ...
            setOf("org.inventivetalent:bossbarapi:2.4.1")
        ),
        Plugin(
            "HologramAPI",
            setOf("https://repo.inventivetalent.org/content/groups/public/"),
            setOf("org.inventivetalent:hologramapi:1.4.0")
        ),
        Plugin(
            "ProtocolLib",
            setOf("http://repo.dmulloy2.net/nexus/repository/public/"),
            setOf("com.comphenix.protocol:ProtocolLib:4.4.0")
        )
    )
}